...
<body>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?=$row['semester']?></td>
                        <td>
                        <a class="btn btn-primary" href="input_nilai.php?id=<?=$row['id']?>&pertemuan=<?=$_GET['pertemuan']?>&code=<?=$_GET['code']?>" role="button">nilai</a>
                        </td>
                    </tr>
            <?php
                }
        ...
        <a class="btn btn-primary" href="nilai.php?code=<?=$_GET['code']?>&pertemuan=<?=$_GET['pertemuan']?>" role="button">Back</a>
    </div>
    </div>
    </div>
    </div>
