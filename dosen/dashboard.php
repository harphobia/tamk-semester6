        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?=$row['jadwal']?></td>
                        <td>
                        <a class="btn btn-primary" href="list_siswa.php?code=<?=$row['code']?>" role="button">Lihat Siswa</a>
                        <a class="btn btn-primary" href="edit_kelas.php?code=<?=$row['code']?>" role="button">Edit Kelas</a>
                        </td>
                    </tr>
            <?php
                }
