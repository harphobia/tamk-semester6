...
<body>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?=$row['semester']?></td>
                        <td>
                        <a class="btn btn-primary" href="tambah_absensi_controller.php?id=<?=$row['id']?>&code=<?=$_GET['code']?>&pertemuan=<?=$_GET['pertemuan']?>&status=1" role="button">Hadir</a>
                        <a class="btn btn-warning" href="tambah_absensi_controller.php?id=<?=$row['id']?>&code=<?=$_GET['code']?>&pertemuan=<?=$_GET['pertemuan']?>&status=0" role="button">Tidak Hadir</a>
        ...
        <a class="btn btn-primary" href="absensi.php?code=<?=$_GET['code']?>&pertemuan=<?=$_GET['pertemuan']?>" role="button">Back</a>
    </div>
    </div>
    </div>
    </div>
